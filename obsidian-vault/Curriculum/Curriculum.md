...
## Learning Paths (See Child Notes)

This curriculum branches into 4 primary career-focused learning paths:

1. **[[OSINT Specialist Path]]** - Open-source intelligence, geolocation, SOCMINT, dark web
2. **[[Financial Investigator Path]]** - Corporate intel, fraud detection, crypto tracing
3. **[[Threat Intel Analyst Path]]** - APT tracking, nation-state threats, attribution
4. **[[Security Researcher Path]]** - Bug bounty, penetration testing, vulnerability research
...
**Unlock**: 25+ campaigns, published research
...
⬇️ **Learning Paths**: [[OSINT Specialist Path]], [[Financial Investigator Path]], [[Threat Intel Analyst Path]], [[Security Researcher Path]]

📚 **Full Documentation**: See `../docs/CURRICULUM.md` in app repository

🔄 **Sync Status**: Run `npm run sync:learning-paths` to export to app
...
**Source**: This is the canonical education framework for Atropos

  ...
  return (
    <div className="space-y-6">
              ...
              {steps.map((step) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={activeStep === step.num ? 'text-amber-400' : 'text-stone-500'}>
                      {step.icon}
                    </span>
                  </div>
                  <p className={`text-xs font-bold ${activeStep === step.num ? 'text-amber-400' : 'text-stone-400'}`}>
                    {step.title}
                  </p>
                  <p className="text-[10px] text-stone-600 mt-0.5 line-clamp-2">{step.desc}</p>
                </button>
              ))}
            </div>
          </CardContent>
        ...
        <Tabs value={`step-${activeStep}`} className="space-y-4">
          <TabsList className="bg-[#0a0500] border border-amber-900/30 w-full justify-start overflow-x-auto">
            {steps.map((step) => (
              <TabsTrigger 
                key={step.num}
                value={`step-${step.num}`}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-stone-500 text-xs mb-2">Paste the long conversation you want to compress:</p>
                    <Textarea 
                  ...
                  <div>
                    ...
                    <p className="text-stone-500 text-xs mb-2">Dense summary for handoff (edit manually or use AI):</p>
                    <Textarea 
                ...
                <div className="bg-black/50 border border-amber-900/20 rounded-lg p-3">
                  ...
                  <pre className="text-[10px] text-stone-400 font-mono whitespace-pre-wrap">{CONTEXT_COMPRESSION_PROMPT}</pre>
                </div>
            ...
            <Card className="bg-black/50 border-amber-900/30">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-stone-500 text-xs mb-2">What should the new agent do first?</p>
                  <Textarea 
                    value={taskFocus}
            ...
            <Card className="bg-black/50 border-amber-900/30">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-amber-900/10 border border-amber-900/30 rounded-lg p-3 text-xs">
                  ...
                  <ol className="text-stone-400 space-y-1 list-decimal list-inside">

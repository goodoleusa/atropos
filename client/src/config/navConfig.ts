...
export const USER_NAV: NavSection = {
  ...
  items: [
    ...
    { path: '/campaigns', icon: Shield, label: 'AI Academy', color: 'teal' },
    ...
    { path: '/mission', icon: Map, label: 'Mission Control', color: 'amber' },
    { path: '/void', icon: Sparkles, label: 'The Void', color: 'teal' },
    { path: '/profile', icon: User, label: 'Profile', color: 'teal' },

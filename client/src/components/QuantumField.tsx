...
export const QuantumField = () => {
  ...
  return (
    <>
      {/* Probability Field Indicator - Subtle corner element */}
      <div 
        className="fixed bottom-4 left-20 z-40 cursor-pointer group"
      ...
      <AnimatePresence>
        {showMeter && (
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
            className="fixed bottom-16 left-20 z-40 w-64 bg-[#0a0500]/95 border border-amber-900/50 rounded-lg p-4 backdrop-blur-md"
          >

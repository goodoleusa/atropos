      ...
      <div className="space-y-2 md:space-y-3">
        ...
        <div className={`rounded-lg border p-2 md:p-2.5 ${styleMeta.color.replace('text-', 'border-').replace('400', '800/40')} bg-stone-900/30`}>
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[8px] text-stone-600 ml-auto">Change in Mission Control</span>
          </div>
    ...
    <div className="space-y-2 md:space-y-3">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5 md:gap-2">
          <div className="flex items-center gap-1 px-1.5 md:px-2 py-0.5 rounded bg-stone-900/50 border border-stone-800 shrink-0">
          ...
          {[
            ...
            <div key={section.label} className="space-y-1.5">
              <div className="flex items-center gap-2 px-1 pt-1">
                ...
                <span className="text-[9px] font-bold uppercase tracking-widest text-stone-600">{section.label}</span>
                <div className="h-px flex-1 bg-stone-800" />
              </div>
